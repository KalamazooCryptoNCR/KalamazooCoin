...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kalamazoocoin-project/kalamazoocoin>";
    const std::string URL_WEBSITE = "<https://kalamazoocoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Kalamazoocoin version %s\n", FormatFullVersion());
}
