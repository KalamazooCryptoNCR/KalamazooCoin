...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kalamazoocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kalamazoocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kalamazoocoin transaction") + "\n" +
              "  kalamazoocoin-tx [options] -create [commands]   " + _("Create hex-encoded kalamazoocoin transaction") + "\n" +
              "\n";
